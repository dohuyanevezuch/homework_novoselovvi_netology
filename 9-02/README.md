...
Логи Агента на ВМ отдельно от сервера

![tasp2_pic3](./img/02/task2_pic3.png)

>!TIP
> Я сидел-сидел, так и не смог понять, почему в логах есть ошибка и на сколько она критична, буду признателен, если сориентируете
